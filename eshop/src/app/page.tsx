      ...
      <header className="sticky top-0 z-50 bg-white border-b border-zinc-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 flex items-center justify-between h-16">
          ...
          <div className="flex items-center gap-3">
            ...
            <Link href="mnt/user-data/login" className="text-sm font-medium text-zinc-700 hover:text-zinc-900 transition-colors hidden sm:block">Sign in</Link>
            <Link href="mnt/user-data/login" className="text-sm font-semibold bg-zinc-900 text-white px-4 py-2 rounded-full hover:bg-zinc-700 transition-colors hidden sm:block">Get started</Link>
          </div>
        </div>
      </header>
      ...
      <section className="bg-white border-b border-zinc-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 py-16 md:py-24">
          <div className="max-w-2xl">
            ...
            <div className="flex items-center gap-3">
              <Link href="/mnt/user-data/category" className="bg-zinc-900 text-white px-6 py-3 rounded-full font-semibold text-sm hover:bg-zinc-700 transition-colors">
                Shop now
              </Link>
